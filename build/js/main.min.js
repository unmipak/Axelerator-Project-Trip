...
var videoBtn = document.querySelector('.hero__video-btn');
var mobilePoster = 'img/video-tablet.jpg';
var defaultPoster = 'img/video-desktop.jpg';
var breakpointMobile = window.matchMedia('(max-width:767px)');
var breakpointTablet = window.matchMedia('(max-width:1199px)');
var slide = document.querySelector('.hero__slide');
var pagination = document.querySelector('.hero__pagination');
...
function heightChecker() {
  ...
  var newPaddingTopMobile = headerHeight + 40 + 'px';
  var newPaddingTopTablet = headerHeight + 70 + 'px';
  var newPaddingTopDesktop = headerHeight + 80 + 'px';
  if (breakpointMobile.matches) {
